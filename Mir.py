	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open Shanto/Update/UCd-xhGAkBU4_0l0CIqwxTjw')
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;91m[1]\033[1;94mClone nejer  Friend List"
	time.sleep(0.05)
	print "\033[1;92m[2]\033[1;94mClone onno karo  friend list"
	time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		jalan('\033[1;91m[+]\033[1;98mMR Shanto█████████████████▒▒▒▒▒▒▒▒..99%')
